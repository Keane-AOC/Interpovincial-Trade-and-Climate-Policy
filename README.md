...
This bar chart displays the total energy available across Canadian provinces in 2025, measured in megawatts. Canada's national total sits at approximately 550 million MW, with the provincial breakdown revealing a stark concentration of energy capacity in a small number of provinces. Quebec leads all provinces at roughly 195 million MW, followed by Ontario at approximately 140 million MW — together accounting for the majority of Canada's total energy availability. Alberta and British Columbia represent a second tier, contributing around 75 million MW and 65 million MW respectively.

The remaining provinces — Saskatchewan, Manitoba, New Brunswick, Newfoundland and Labrador, Nova Scotia, and Prince Edward Island — contribute comparatively minimal amounts, with most registering near zero on the scale of the national total. This sharp drop-off illustrates just how unevenly energy capacity is distributed across the country, with the two central provinces carrying a disproportionate share of the national load. The dominance of Quebec and Ontario reflects their substantial investments in hydroelectric and nuclear infrastructure respectively, while the smaller figures for Atlantic and prairie provinces highlight both their more limited infrastructure and smaller populations. This disparity underscores the case for improved interprovincial energy sharing, as surplus capacity in Quebec and Ontario currently has limited pathways to reach energy-constrained regions.
